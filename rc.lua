...
do
	...
	local function error_handler(err)
	    ...
	    naughty.notify("mpd winget error " .. tostring(err))
...
beautiful.init(os.getenv("HOME") .. "/.config/awesome/themes/custom1/theme.lua")
...
-- mycustommenu = awful.menu({ items= { { "shitty terminal ", "xterm" },
--                                      { "good terminal", "kitty" },
--                                      { "another terminal", "konsole" }
--                                    }
--                           })
...
-- mycustomlauncher = awful.widget.launcher({ image = beautiful.awesome_icon,
--                                            menu = mycustommenu })
...
mytextclock = wibox.widget.textclock("%Y %d.%m, %H:%M:%S", 1)
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "code", "browser", "telegram", "shit", "games", "music", "7", "8", "9" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    -- Handle of volume and microphone buttons
    ...
    awful.key({ }, "XF86AudioMute", function() awful.util.spawn("pactl set-sink-mute @DEFAULT_SINK@ toggle"); naughty.notify{title="Sound control", text="Speakers muted/unmuted"} end),
    awful.key({ }, "XF86AudioMicMute", function() awful.util.spawn("pactl set-source-mute @DEFAULT_SOURCE@C toggle"); naughty.notify{title="Sound control", text="Microphone muted/unmuted"} end),
